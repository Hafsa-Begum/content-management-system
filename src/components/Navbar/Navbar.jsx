      ...
      <header>
        <div className="px-4 py-2 text-white flex  justify-between bg-blue-900">
          ...
          <ul>
            ...
            <Link to="/contents">
            <li className="dropdown md:inline-block cursor-pointer hover:text-gray-500 border-b md:border-none py-2 px-3 relative"><a>Contents</a></li> 
            </Link>
            <Link to="/dashboard">
            <li className="dropdown md:inline-block cursor-pointer hover:text-gray-500 border-b md:border-none py-2 px-3 relative"><a>Dashboard</a></li> 
            </Link>
